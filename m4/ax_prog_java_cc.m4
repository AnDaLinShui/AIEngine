...
#   Ryadnology Team; either version 2 of the License, or (at your
...
# Check on the configure.ac test -z "$JAVA_CC" && AC_MSG_ERROR([no acceptable java compiler found in \$PATH])
])# AX_PROG_JAVA_CC
