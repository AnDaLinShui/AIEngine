 ...
 *
 */
#ifndef SRC_PROTOCOLS_FREQUENCY_FREQUENCYGROUPITEM_H_
#define SRC_PROTOCOLS_FREQUENCY_FREQUENCYGROUPITEM_H_
...
#endif  // SRC_PROTOCOLS_FREQUENCY_FREQUENCYGROUPITEM_H_
