 ...
 *
 */
#ifndef _TEST_QUIC_H_
#define _TEST_QUIC_H_
...
struct StackQuictest : public StackTest
{
        //Protocols
        IPProtocolPtr ip;
        UDPProtocolPtr udp;
        ...
        // FlowForwarders
        SharedPointer<FlowForwarder> ff_udp, ff_quic;
		...
		ff_udp->addUpFlowForwarder(ff_quic);
        }

	void show() {
		udp->statistics(std::cout, 5);
		quic->statistics(std::cout, 5);
	}
