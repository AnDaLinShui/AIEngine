...
public:
	...
	int64_t getCurrentUseMemory() const override { return sizeof(UDPGenericProtocol); }
	int64_t getAllocatedMemory() const override { return sizeof(UDPGenericProtocol); }
	int64_t getTotalAllocatedMemory() const override { return sizeof(UDPGenericProtocol); }
