...
if __name__ == '__main__':
    ...
    """ 
    ssl_sig = pyaiengine.Regex("SSL Basic regex", b"^\x16\x03",
        pyaiengine.Regex("SSL Heartbeat","^.*\x18\x03(\x01|\x02|\x03).*$"))

    """ Set the callback on the latest regex """
    ssl_sig.next_regex.callback = callback_heartbeat
